...
const Create = () => {
  const data = [
    ...
    },
    {
      ...
      description:
        "Click Profile and set up your collection. Add social links, a description, profile & banner images, and set a secondary sales fee.",
      colorbg: "#47A432",
    },
    {
      title: "Gen NFT Image",
      description:
        "Go to the XRender AI site and start using it to mint a new NFT easily and you own them.",
      colorbg: "#9835FB",
    },
    {
      title: "Buy/Sell NFTs",
